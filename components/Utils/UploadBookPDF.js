...
const UploadBookPDF = ({ id, image }) => {
  ...
  function fileUpload(file) {
    ...
    const url = `${Settings.API_DATA_URL}utils/save_book_pdf`;
    ``;
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-fit mb-4 bg-slate-200 border-2 border-slate-300 py-1">
      <form onSubmit={onFormSubmit}>
        <div className="flex flex-col justify-center items-center mx-4">
          <h1 className="py-4">
            Clicked the box below to select a PDF file for upload
          </h1>
          <input
            type="file"
            placeholder=""
